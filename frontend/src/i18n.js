...
const STRINGS = {
  en: {
    ...
    checkin_lead_loading_open: 'Count what you are loading and send it. Your stops open as soon as you do.',
    ...
    pin_missing: 'Nobody has marked this door on the map. Stand at the gate and tap below — it saves where you are.',
    pin_here: 'Pin this door here',
    pin_wrong: 'Pin in the wrong place?',
    pin_saved: 'Saved. This door is on the map now.',
    pin_no_location: 'Could not read your location. Allow location for this site and try again.',
    checkin_load_heading: 'What today needs',
    checkin_load_doors: '{doors} doors',
    checkin_load_door: '1 door',
    ...
    checkin_send_open: 'Send and start',
    ...
    checkin_stops_locked_open: 'Your stops appear here once you send your count.',
  ...
  te: {
    ...
    checkin_lead_loading_open: 'మీరు లోడ్ చేస్తున్నది లెక్కించి పంపండి. పంపిన వెంటనే మీ స్టాప్‌లు కనిపిస్తాయి.',
    ...
    pin_missing: 'ఈ ఇంటిని ఇంకా మ్యాప్‌లో గుర్తు పెట్టలేదు. గేటు దగ్గర నిలబడి కింద నొక్కండి — మీరు ఉన్న చోటు సేవ్ అవుతుంది.',
    pin_here: 'ఈ ఇంటిని ఇక్కడ గుర్తు పెట్టు',
    pin_wrong: 'గుర్తు తప్పు చోట ఉందా?',
    pin_saved: 'సేవ్ అయింది. ఈ ఇల్లు ఇప్పుడు మ్యాప్‌లో ఉంది.',
    pin_no_location: 'మీ లొకేషన్ చదవలేకపోయాం. ఈ సైట్‌కి లొకేషన్ అనుమతి ఇచ్చి మళ్లీ ప్రయత్నించండి.',
    checkin_load_heading: 'ఈ రోజుకి కావలసినవి',
    checkin_load_doors: '{doors} ఇళ్లు',
    checkin_load_door: '1 ఇల్లు',
    ...
    checkin_send_open: 'పంపి మొదలుపెట్టండి',
    ...
    checkin_stops_locked_open: 'మీ లెక్క పంపిన వెంటనే మీ స్టాప్‌లు ఇక్కడ కనిపిస్తాయి.',
